...
After checking again, we can see a commandline was accessed now, through PowerShell.

![VLAN Creatio](../screenshots/Splunk/Threat%20Hunting/Connection%20Monitoring/PowershellTest2.png)

We can also see the IP address of the user, allowing further mitigation action occur.
